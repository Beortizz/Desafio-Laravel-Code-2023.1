...
<div class="row">
    <div class="form-group col-sm-6">
        ...
        <input type="date" name="birth_date" id="birth_date" class="form-control" required autofocus value="{{ old('name',$student->birth_date) }}">
    </div>
    <div class="form-group col-sm-6">
        <label for="phone_number" class="required">Telefone</label>
        <input type="text" name="phone_number" id="phone_number" class="form-control" required autofocus value="{{ old('phone_number',$student->phone_number) }}">
    </div>
</div>
<div class="row">
    <div class="form-group col-sm-6">
        <label for="pay_date" class="required">Data de Pagamento </label>
        <input type="date" name="pay_date" id="pay_date" class="form-control" required autofocus value="{{ old('enter_hour',$student->pay_date) }}">
    </div>
    <div class="form-group col-sm-6">
